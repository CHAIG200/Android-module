...
public class dateDialogOnClickListener implements View.OnClickListener {
     ...
     */
    public dateDialogOnClickListener(Activity activity, EditText editText){
    ...
    /*
        This changes the text of the editText that was selected to the date that was selected.
     */
    @Override
    public void onClick(View view) {
        SortSelector sortSelector = new SortSelector(activity);
        sortSelector.setDateField(editText).show();
    }
}
